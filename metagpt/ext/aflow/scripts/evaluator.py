...
class Evaluator:
    ...
    async def graph_evaluate(
        self, dataset: DatasetType, graph, params: dict, path: str, eval_list: list = None, is_test: bool = False
        ...
        return await benchmark.run_evaluation(configured_graph, va_list=eval_list)
